 ...
 * @param (sig_x, sig_y) landmark measurement uncertainties [standard deviation of x [m], 
 *   standard deviation of y [m]]
 * @param (x_obs,y_obs) x_obs and y_obs coordinates of observed measurement point
 * @param (mu_x,mu_y) mu_x and mu_x coordinates of associated landmark point
 * @output weight of the particular observation
 */

inline double multivariate_gaussian_probability_density(double sig_x, double sig_y, double x_obs, double y_obs,
